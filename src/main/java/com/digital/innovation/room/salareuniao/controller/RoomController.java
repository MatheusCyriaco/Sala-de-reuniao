package com.digital.innovation.room.salareuniao.controller;

import com.digital.innovation.room.salareuniao.expection.ResourceNotFoundException;
import com.digital.innovation.room.salareuniao.model.Room;
import com.digital.innovation.room.salareuniao.repository.RoomRepository;
...
public class RoomController {
    ...
    public ResponseEntity<Room> updateRoom(@PathVariable(value = "id") Long roomId, @Valid @RequestBody Room roomDetails)
        throws ResourceNotFoundException { Room room = roomRepository.findById(roomId)
